...
public class JavaMd5 {
    ...
    //四个寄存器的初始向量IV,采用小端存储
    static final long A = 0x67552301L;  // 0x67452301
    static final long B = 0xEDCDAB89L;  // 0xefcdab89
    static final long C = 0x98BADEFEL; // 0x98badcfe
    static final long D = 0x16325476L; // 0x10325476L
    ...
    //开始使用MD5加密
    public String start(byte[] inputBytes) {
        //转化为字节数组
...
//        byte[] inputBytes = message.getBytes();
    ...
    private static long[] divide(byte[] inputBytes, int start) {
        //存储一整个分组,就是512bit,分成16组，数组里每个是32bit，就是4字节，为了消除符号位的影响，所以使用long
        long[] group = new long[16];
        for (int i = 0; i < 16; i++) {
            //每个32bit由4个字节拼接而来
            //小端的从byte数组到bit恢复方法 按位或运算
    ...
    public String intToHex(int arg){
        Integer in = Integer.valueOf(""+arg, 16);
...
//                System.out.println("明文信息》》》》》》"+groups[k[n][i]]+
//                        ">>>>>>>"+(n+1)+">>>>k值："+T[n][i]+">>k值位置"+n+"-"+i+"xxx:"+g(n, result[1], result[2], result[3]));
...
//        JavaMd5 md = new JavaMd5();
////        String message = "abcdefg";
//        String message = "";
//        byte[] b1 = ZYSign.hexToBytes(message);
//        System.out.println("MD5-Algorithm:\n\nOrigin Message: " + message);
//        System.out.println("Result Message: " + md.start(b1));
//        System.out.println("Result Message(UpperCase): " + md.resultMessage.toUpperCase());
////        System.out.println("标准："+JavaMd5.getMd5("4A5E9A20-8933-4E2D-839A-0DFCF9EA72471623418015891r0ysuetd9#Kn_p7vUw"));
////        System.out.println(md.T[0][0]);
//    }
}
